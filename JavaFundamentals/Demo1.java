...
public class Demo1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < lift.length; i++) {
            if ((lift[i] < 4)) {                     //проверка дали има свободни места в кабинката
                if (people >= 4 - lift[i]) {         //провера дали хората на опашката са равни или повече от свободните места в кабинката
